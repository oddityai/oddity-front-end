...
const Buttons = ({ children, handleClick, tutorhandleFeedback }) => {
  return (
    <div
        ...
        <div style={{ padding: 16 }}>
          ...
          >
            ...
            <div style={{ padding: 16, backgroundColor: "#f5f5f5" }}>
              ...
              <Button
                onClick={() => handleClick("tutorenglish")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorprompt")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorhistory")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorscience")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorengineering")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorhealth")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorbusiness")}
                style={{
                  zIndex: 10,
            ...
            >
              ...
              <Button
                onClick={() => handleClick("tutorpsychology")}
                style={{
                  zIndex: 10,
